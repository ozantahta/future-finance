...
export function MarketStatsSkeleton() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {[...Array(4)].map((_, i) => (
        <Card key={i} className="bg-gray-800/60 backdrop-blur-lg border border-cyan-400/20 shadow-2xl">
    ...
    <Card className="bg-gray-800/60 backdrop-blur-lg border border-cyan-400/20 shadow-2xl">
      ...
      <CardContent>
        <div className="space-y-4">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="flex items-center justify-between p-4 rounded-xl bg-gray-700/30 border border-gray-600/30">
